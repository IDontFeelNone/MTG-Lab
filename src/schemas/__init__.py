...
SCHEMA_VERSION="v1"
SCHEMA_NAMES=("card","product","printing","slot","print-sheet","source-record","acquisition-manifest","evidence-manifest","parsed-record-artifact","normalized-candidate-artifact","promotion-audit")
