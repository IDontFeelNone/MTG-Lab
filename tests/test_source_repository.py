...
class SourcesTests(unittest.TestCase):
 def test_mb2_loads(self): self.assertEqual(load_acquisition_manifest("magic","mystery_booster_2","mystery_booster_2_product_overview")["acquisition_status"],"planned")
