...
The persistence layer will conceptually provide tables for projects, questions, hypotheses, experiments, datasets, simulation runs, observations, conclusions, findings, evidence, attachments, tags, versions, and citations. Association tables will represent authorship, tagging, domain links, evidence relationships, experiment inputs and outputs, hypothesis evaluation, conclusion support, contradiction, and supersession.
